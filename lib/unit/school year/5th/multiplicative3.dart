...
class Multiplicative3 extends StatefulWidget {
  const Multiplicative3({Key? key, required String format}) : super(key: key);

  @override
  State<Multiplicative3> createState() => _DivisionProblemsState();

  static List<Problem> generateProblems() {
    List<Problem> problems = [];
    for (int i = 0; i < 10; i++) {
      final a = Random().nextInt(90) + 10;
      final b = a * (Random().nextInt(90) + 10);
...
class _DivisionProblemsState extends State<Multiplicative3> {
  ...
  void _generateProblems() async {
    ...
    List<Problem> generatedProblems = Multiplicative3.generateProblems();
