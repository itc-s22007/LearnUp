...
class DivisionProblems2 extends StatefulWidget {
  const DivisionProblems2({Key? key, required String format}) : super(key: key);

  @override
  State<DivisionProblems2> createState() => _DivisionProblemsState();
...
class _DivisionProblemsState extends State<DivisionProblems2> {
  ...
  void _generateProblems() async {
    ...
    List<Problem> generatedProblems = DivisionProblems2.generateProblems();
