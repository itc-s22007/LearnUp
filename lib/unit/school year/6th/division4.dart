...
class DivisionProblems4 extends StatefulWidget {
  const DivisionProblems4({Key? key, required String format}) : super(key: key);

  @override
  State<DivisionProblems4> createState() => _DivisionProblemsState();
...
class _DivisionProblemsState extends State<DivisionProblems4> {
  ...
  void _generateProblems() async {
    ...
    List<Problem> generatedProblems = DivisionProblems4.generateProblems();
