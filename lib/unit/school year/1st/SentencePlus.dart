...
class SentencePlus extends StatefulWidget {
  ...
  static List<Problem> generateProblems() {
    final List<String> templates = [
      ...
      '{name}は{a}このあめをもっています。おばあちゃんが{b}このあめをくれました。ぜんぶであめはなんこのなりましたか？',
      '{name}は{a}ひきのさかなをつりました。おとうさんが{b}ひきのさかなをくれました。さかなはぜんぶでなんびきいますか？',
      '{name}は{a}まいのシールをもっています。せんせいが{b}まいのシールをくれました。シールはぜんぶでなんまいですか？',
      '{name}は{a}だいのブロックをもっています。おにいちゃんが{b}だいのブロックをくれました。いまブロックはなんだいありますか？',
      '{name}は{a}わのかみひこうきをつくりました。おともだちが{b}わのかみひこうきをつくってくれました。かみひこうきはぜんぶでなんわありますか？',
      '{name}は{a}まいのきってをあつめました。おじいちゃんが{b}まいのきってをくれました。ぜんぶできってはなんまいですか？',
    ];

    final List<String> names = ['ぎんじ', 'かに', 'りおん', 'ショーン', 'いしき'];
